/**
 * Apply Group 3: breakable_target in 1 scene (FieldRuins.scene node#289).
 */
import { readFileSync, writeFileSync, copyFileSync } from 'node:fs';
import { join } from 'node:path';

const WISDOM = 'E:/cv5/wisdom';
const BINDING_KEY = 'breakable_target';
const NEW_SELECTED_PATH = 'assets/art/generated/enemy/breakable_target.png';
const NEW_TEX_UUID = '69ec051a-3fe0-4280-8346-a6954fe76680@6c48a';

const ASSET_BINDING_TAG_TYPE = '3d2a6zMsZNMmK4uaNDa0rs2';
const SCENE_DRESSING_SKIN_TYPE = '5a770BhwHBNKL5hXAituhD+';

const SCENES = ['assets/scenes/FieldRuins.scene'];
  ...
  for (const [nid, { tags, skins }] of byNode) {
    for (const ti of tags) {
      ...
      for (const si of skins) {
        ...
        if (currUuid === NEW_TEX_UUID) continue;
